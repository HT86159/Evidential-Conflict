    ...
    def sample(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            # down_proj_input=outputs[-1]
            # down_proj_input_list.append(down_proj_input)
            # outputs=outputs[0]
            ...
            probs_before=nn.functional.softmax(next_token_scores, dim=-1)

            # all_probs.append(probs_before)
            all_probs.append(probs_before.max())
            probs_distributions.append(probs_before)
        ...
        if return_dict_in_generate:
            ...
            # return input_ids,all_probs,probs_distributions,hidden_states_list,down_proj_input_list
            return input_ids,all_probs,probs_distributions,hidden_states_list
